...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="http://localhost:80/v2cristian/public/dist/img/XperienceUML.png" />
...
?>
<?php echo ($mostraractividad['title'] . '/' . $mostrarcurso['name']);
...
?>
                        ...
                        <h3><em>Contexto</em>:
                        <?php printf($mostraractividad['description']);

?>

                        </h3>
                        <select name="user" id="user" class="form-group">
                            <option value="0">---Especifique Usuario---</option>

                            <?php
while ($li = mysqli_fetch_assoc($resuluser)) {?>
                                    <option value = " <?php echo $li['name']; ?> "><?php echo $li['name']; ?></option>

                                <?php }?>
                        </select>

                        <select name="actividad" id="actividad" class="form-group">
                            <option value="0">---Especifique Actividad---</option>

                            <?php
while ($li2 = mysqli_fetch_assoc($resultact)) {?>
                                    <option value = " <?php echo $li2['title']; ?> "><?php echo $li2['title']; ?></option>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="http://localhost:80/v2cristian/public/index.php">Inicio</a></li>
    ...
    var datajson=myDiagram.model.toJson();
        ...
        $.post("insertmodel.php",{ actividad : actividad },{user:user},{datajson:datajson},function(response){
    ...
    <body onload="init()">
        <div>
            <div>
                <button id="SaveButton" onclick="save()"><strong>Salvar</strong></button>
                <button onclick="load()"><strong>Cargar</strong></button>
                <button onclick="storeTask()"><strong>Entregar Tarea</strong></button>
