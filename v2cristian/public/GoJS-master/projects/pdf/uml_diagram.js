...
async function finished() {
    ...
    if (document.getElementById('user').value === undefined) {
        ...
        const response = await fetch('http://localhost:80/v2cristian/public/index.php/xapi/newmodeldiagram', {
            method: 'POST',
            ...
            if (response.ok) {
                window.location.replace("http://localhost:80/v2cristian/public/index.php/model/diagram/test/")
            } else {
