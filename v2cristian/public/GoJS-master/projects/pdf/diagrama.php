        ...
        <section >
            ...
            <div class="container-fluid" style="background-color:#f4f6f9">
                    <?php
                        ...
                        $response_course = json_decode(file_get_contents('http://localhost:80/v2cristian/public/index.php/xapi/course'), true);
                        $response_activity = json_decode(file_get_contents('http://localhost:80/v2cristian/public/index.php/xapi/modelActivity'), true);
                    ?>
